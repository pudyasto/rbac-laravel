<form name="form_default" id="form_default" autocomplete="off" method="POST" action="{{$url}}">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan nama role" value="{{ isset($data->name) ? $data->name : '' }}" required>
    </div>
...
<script defer src="{{ asset('/js/rbac/roles/form.js?v=' . rand(1,100)) }}"></script>